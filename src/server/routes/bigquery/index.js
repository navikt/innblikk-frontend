...
import { createGoalCompletionRoutes } from './goalCompletionRoutes.js'
...
import { createChartbuilderDndRouter } from '../chartbuilderdnd/index.js'
...
export function createBigQueryRouter({ bigquery, GCP_PROJECT_ID, BIGQUERY_TIMEZONE }) {
  ...
  router.use(createGoalCompletionRoutes({ bigquery, GCP_PROJECT_ID }))
  ...
  router.use(createChartbuilderDndRouter({ bigquery }))
