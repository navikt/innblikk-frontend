...
export default function SqlEditor() {
  ...
  return (
      ...
      filters={
        <>
          ...
          {estimate && showEstimate && (
            <CostEstimateDisplay estimate={estimate} onDismiss={() => setShowEstimate(false)} />
          )}
    ...
    >
      {error && (
        <QueryErrorDisplay error={error} lastProcessedSql={lastProcessedSql} onAddDateFilter={handleAddDateFilter} />
      )}
