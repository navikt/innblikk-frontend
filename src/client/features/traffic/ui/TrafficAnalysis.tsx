...
const TrafficAnalysis = () => {
  ...
  const BridgedChartDataTable = useCallback(
    (props: {
  ...
  const BridgedTrafficTable = useCallback(
    (props: {
      title: string
  ...
  const BridgedCombinedEntrancesTable = useCallback(
    (props: {
      title: string
  ...
  const BridgedExternalTrafficTable = useCallback(
    (props: {
      title: string
      ...
      filters={
        <>
          ...
          <div className="w-full sm:w-auto min-w-[200px]">
            ...
            >
              <option value="visitors">{currentDateRange ? getVisitorLabelWithBadge() : 'Unike besøkende'}</option>
