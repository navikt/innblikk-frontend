  ...
  return (
    <div className="flex flex-col">
      <div className="overflow-x-auto">
        <Table size="small" className="[&_th:first-child]:pl-0 [&_td:first-child]:pl-0">
          <Table.Header>
            <Table.Row>
              ...
              return (
                <Table.Row key={i}>
                  {keys.map((key, j) => {
                    ...
                    const displayVal =
                      typeof val === 'number' ? val.toLocaleString('nb-NO') : formatSpecialTableValue(translatedVal)
      ...
      {totalRows > rowsPerPage ? (
        <div className="flex justify-center pb-4 pt-2">
          <Pagination page={page} onPageChange={onPageChange} count={totalPages} size="small" />
        </div>
      ) : (
