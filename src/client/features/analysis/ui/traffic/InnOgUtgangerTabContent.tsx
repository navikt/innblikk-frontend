...
const InnOgUtgangerTabContent = ({
  ...
  if (
    hasAttemptedFetch &&
    (isLoadingExternalReferrers || !hasFetchedExternalReferrers || isLoadingBreakdown || !hasFetchedBreakdown)
  ) {
    return (
      ...
      <div className="w-full md:flex-1 md:basis-0 min-w-0 flex flex-col gap-8">
        ...
        <div className="rounded-lg border border-[var(--ax-border-neutral-subtle)] bg-[var(--ax-bg-default)] p-6">
          <Heading level="3" size="small" className="mb-3">
            Vil du se hele brukerreisen?
          </Heading>
          <p className="text-[var(--ax-text-subtle)] mb-5">
            Siden du er på nå viser hvor besøk starter og slutter. I navigasjonsflyt ser du hele reisen gjennom
            nettstedet.
          </p>
          <Button
            variant="secondary"
