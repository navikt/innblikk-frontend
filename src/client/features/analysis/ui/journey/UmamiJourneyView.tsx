            ...
            {stepsData.map((stepData) => (
              <div key={stepData.step} className="flex-shrink-0 w-60 flex flex-col gap-4">
                ...
                <div className="flex flex-col items-center mb-2">
                  <div
                    className="h-8 px-3 rounded-full text-white flex items-center justify-center font-bold text-sm mb-2 shadow-sm border border-transparent dark:border-[var(--ax-border-neutral-subtle)] whitespace-nowrap"
                    style={{ backgroundColor: 'var(--funnel-box-bg, rgb(19, 17, 54))' }}
                  >
                      ...
                      >
                        ...
                        <div className="relative z-10 p-2.5 flex justify-between items-center gap-2">
                          <div className="flex items-center gap-2 overflow-hidden flex-1 min-w-0 group/text">
                            <span className="text-gray-400 flex-shrink-0 text-xs mt-0.5 self-start">📄</span>
