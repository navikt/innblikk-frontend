  ...
  return (
    <>
      <PageHeader
        ...
        description={
          <>
            Slik håndterer vi personvern og sikkerhet på{' '}
            <Link href="https://innblikk.ansatt.nav.no" className="underline hover:no-underline">
              Innblikk
            </Link>
          </>
        }
            ...
            <VStack gap="space-12">
              <section>
                ...
                <p className="mb-4 leading-normal">
                  Innblikk er en nettside for Nav Arbeids- og velferdsdirektoratet. Personvernerklæring for behandling
                  av personopplysninger. For mer info:{' '}
                  <Link
              ...
              <section className="pt-16">
                ...
                <p className="mb-4 leading-normal">
                  ...
                  å se hvem som har gjort hvilke spørringer og har hatt tilgang til eventuelle personopplysninger som er
                  innsamlet ved en feil.
                </p>
                <p className="mb-4 leading-normal">
                  Personopplysningene dine deles ikke med andre aktører, men vil kunne deles med den registrerte dersom
                  denne ber om innsyn etter personopplysningloven.
                </p>
              ...
              <section className="pt-16">
                ...
                <Box className="my-4 p-6 border border-border-subtle rounded-medium">
                  <p className="mb-4 leading-normal">
                    ...
                    Noen av informasjonskapslene er nødvendige for at ulike tjenester på nettsiden vår skal fungere slik
                    vi ønsker.
                  </p>
                  <p className="leading-normal">
                    Vi bruker informasjonskapsler til å forbedre brukeropplevelsen og innholdet. Når du besøker
                    aksel.Nav.no, sender nettleseren din opplysninger til Navs analyseverktøy.
                  </p>
                </Box>
              ...
              <section className="pt-16">
                ...
                <p className="mb-4 leading-normal">
                  Du har blant annet rett til innsyn i hvilke opplysninger vi har lagret om deg. Les mer her om dine
                  rettigheter og hvordan du gjør krav på disse{' '}
                  <Link
              ...
              <section className="pt-16">
                ...
                <p className="mb-4 leading-normal">
                  ...
                  <Link href="https://www.nav.no/personvern" className="underline hover:no-underline">
                    personvernombud
                  </Link>{' '}
                  som skal ivareta personverninteressene, også til de ansatte. Personvernombudet kan gi råd og
                  veiledning generelt om Navs behandling av personopplysninger og kan hjelpe deg med å ivareta dine
              ...
              <section className="pt-16">
                ...
                <p className="leading-normal">
                  Du har rett til å klage til Datatilsynet hvis du ikke er fornøyd med hvordan vi behandler
                  personopplysninger om deg, eller hvis du mener behandlingen er i strid med personvernreglene. Ta først
                  kontakt med vårt personvernombud. Informasjon om hvordan du går frem finner du på nettsidene til{' '}
                  <Link href="https://www.datatilsynet.no/" className="underline hover:no-underline">
                    Datatilsynet
                  </Link>
                  .
                </p>
