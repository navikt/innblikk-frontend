...
const Footer = () => {
    return (
        ...
        >
            <div className="relative z-10 mx-auto grid w-full gap-12 px-4 pb-16 pt-12 md:grid-cols-2 md:px-6 lg:grid-cols-2 xl:grid-cols-4 xl:gap-6" style={{ maxWidth: "var(--app-max-width)" }}>
                    <LogoBlock />
                    <SideLenker />
                    <Snarveier />
                    <Kontakt />
